  ...
  <view class="container">
    <view class="grid" style="padding-left: 30rpx;padding-right: 30rpx;">
		<u-form :model="form" ref="uForm">
			...
			<u-form-item label="领用人:" prop="principal" label-width="130"><u-input v-model="form.principal" placeholder="请填写责任人" input-align="right"/></u-form-item>
			<u-form-item label="使用地点:" prop="address" label-width="130"><u-input v-model="form.address" placeholder="请填写存放地点" input-align="right"/></u-form-item>
...
<script>
	...
	export default {
	  ...
	  methods: {
		...
		getLightType() {
			vk.callFunction({
			  url: 'client/type/kh/select',
			  title: '请求中...',			  
			  success:function(data){				
			    that.form.principal = data.userInfo.nickname;
