	...
	<view class="app login">
		...
		<view class="content">
			...
			<view class="login-btn">
				<u-button shape="circle" @click="login" :plain="false" :hair-line="false" type="primary">登 录</u-button>
			</view>
			<!-- 其他登录 -->
			<view class="other_login cuIcon">
				<!-- #ifdef MP-WEIXIN -->
				<view class="login_icon" style="text-align: center;margin-top: 20rpx;">
